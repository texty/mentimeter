<script>
  ...
  function drawChart() {
    ...
    if (selectedRange) {
      ...
      // Додавання SVG іконки хрестика
      const crossIcon = clearButton.append("g")
        .attr("transform", `translate(${innerWidth - 19}, 10)`); // Центруємо відносно кола
      crossIcon.append("path")
        .attr("stroke", "white")
        .attr("stroke-width", "1.5")
        .attr("stroke-linecap", "round")
        .attr("d", "M2 2l4 4M6 2l-4 4");
    }
